...
class Hospital(object):
    ...
    def admit(self, patient):
        if self.occupancy < len(self.beds):
            ...
            print "Naaaaahhhh... Get out. Next!!"
        return -1
    def discharge(self, patient):
        for i in range(len(self.beds)):
            if self.beds[i] == patient.bed_number:
                print "You're free to go.", i
    ...
    def display_all(self):
        ...
        return self
print " "
p1 = Patient(1, "Joshua", "everything").display_all()
p2 = Patient(2, "Malechai", "cats").display_all()
p3 = Patient(3, "Ted", "peanuts").display_all()
p4 = Patient(4, "Franko", "none").display_all()
